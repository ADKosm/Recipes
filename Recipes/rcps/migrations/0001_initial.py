# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2016-12-11 13:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='ingredients', through='rcps.AlternativeConsists', to='rcps.Ingredient')),
                ('original_ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rcps.Ingredient')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rcps.Equipment')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rcps.Recipe')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(through='rcps.Requires', to='rcps.Recipe'),
        ),
        migrations.AddField(
            model_name='consist',
            name='ingredient',
